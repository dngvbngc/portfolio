export default [
  {
    ...
    image: "",
    description:
      "Integrum Global's AI assistant for ISO 27001/42001 compliance auditing and documentation",
    stack: ["Gemini", "MCP", "RAG", "LangChain"],
    github: "",
    live: "",
  },
  {
    ...
    image: "",
    description:
      "Add-on chakra ball effects for dance videos using AI/ML pose detection",
